...
async function starts() {
	...
	console.log(color('[ BOT]','aqua'), color("A", "yellow"))
	console.log('>', '[',color('INFO','blue'),']','A...')
	FxBot.on('qr', () => {
